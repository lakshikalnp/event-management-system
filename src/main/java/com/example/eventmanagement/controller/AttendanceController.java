...
public class AttendanceController {
    ...
    @PostMapping
    public ResponseEntity<String> recordAttendance(@RequestBody AttendanceRequestDto request) {
        ...
        log.info("AttendanceController.recordAttendance req-> success");
        return ResponseEntity.ok("Attendance successfully added with userId: "+attendanceResponseDto.getUserId()+" eventId: "+attendanceResponseDto.getEventId());
    }
